...
{
    private DroneBaseState currentState;
...
//
//     private TileData currentTileInfo;
//     private TileData nextTileInfo;
//
...
//         currentTileInfo = currentTile.GetTileData();
...
//     if (currentTarget == target.resource)
//     {
//         directTargets.AddRange(validNeighbors.Where(tile => tile.tileData.hasResource));
//     }
//     else if (currentTarget == target.queen)
//     {
//         directTargets.AddRange(validNeighbors.Where(tile => tile.tileData.hasQueen));
//     }
//     
...
//     {
//         var matchingPheromone = tile.tileData.pheromones.FirstOrDefault(p =>
